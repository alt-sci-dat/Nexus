...
export const opticsConcepts: Concept[] = [
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Slide the cube toward the wall.", expect: "Shadow shrinks toward the cube's real size." },
        { action: "Slide the cube toward the lamp.", expect: "Shadow grows huge — small block makes giant dark patch." },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Set f=2, object at 4.", expect: "Image inverted, same size." },
        { action: "Object at 1.5 (less than f).", expect: "Virtual image, magnified, upright (rays diverge after lens)." },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Set incident angle 35°, n₂=1.33.", expect: "Refracted angle ≈ 25°." },
        { action: "Increase angle past 49° (water→air).", expect: "Total internal reflection." },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Increase dispersion slider.", expect: "Color rays fan out wider." },
        { action: "Reduce to zero.", expect: "All colors emerge parallel — no splitting." },
      ],
