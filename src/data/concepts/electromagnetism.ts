...
export const emConcepts: Concept[] = [
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Magnets close, opposite poles facing.", expect: "Tight blue field lines pulling them together.", paramSet: { separation: 2, repel: 0 }, durationSec: 4 },
        { action: "Push them apart.", expect: "Lines stretch but still arc N→S.", paramSet: { separation: 5, repel: 0 }, durationSec: 4 },
        { action: "Flip one pole — same poles now face.", expect: "Field bows outward; repulsion.", paramSet: { separation: 3, repel: 1 }, durationSec: 4 },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Low voltage, low resistance.", expect: "Faint glow, slow electrons.", paramSet: { voltage: 3, resistance: 3 }, durationSec: 4 },
        { action: "Crank voltage up.", expect: "Bulb glows brighter, electrons race.", paramSet: { voltage: 12, resistance: 3 }, durationSec: 4 },
        { action: "Add resistance.", expect: "Current drops, bulb dims.", paramSet: { voltage: 12, resistance: 9 }, durationSec: 4 },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "V=9, low R.", expect: "Strong current, bright bulb.", paramSet: { voltage: 9, resistance: 1.5 }, durationSec: 4 },
        { action: "Slide R up to 10.", expect: "Brightness drops sharply (P=V²/R).", paramSet: { voltage: 9, resistance: 10 }, durationSec: 5 },
        { action: "Drop V back to 3 at R=3.", expect: "Dim — V² dominates power.", paramSet: { voltage: 3, resistance: 3 }, durationSec: 4 },
        { action: "Crank V back to 12 at R=3.", expect: "16× brighter than before.", paramSet: { voltage: 12, resistance: 3 }, durationSec: 4 },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Slow magnet motion.", expect: "Faint LED pulse.", paramSet: { magnetSpeed: 0.5, turns: 18 }, durationSec: 4 },
        { action: "Speed up the magnet.", expect: "LED flashes bright.", paramSet: { magnetSpeed: 4, turns: 18 }, durationSec: 4 },
        { action: "Add more coil turns.", expect: "EMF grows linearly with N.", paramSet: { magnetSpeed: 4, turns: 40 }, durationSec: 4 },
        { action: "Stop the magnet.", expect: "LED dies — no flux change.", paramSet: { magnetSpeed: 0, turns: 40 }, durationSec: 3 },
      ],
