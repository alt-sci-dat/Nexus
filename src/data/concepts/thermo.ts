...
export const thermoConcepts: Concept[] = [
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Cold gas at 100 K.", expect: "Slow particles, deep blue glow.", paramSet: { temperature: 100 }, durationSec: 4 },
        { action: "Room temperature 300 K.", expect: "Moderate jiggle; mid-spectrum colors.", paramSet: { temperature: 300 }, durationSec: 4 },
        { action: "Heat to 800 K.", expect: "Fast bright particles, frequent wall hits.", paramSet: { temperature: 800 }, durationSec: 4 },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Cold limit (100 K).", expect: "Slow blue particles, sparse hits.", paramSet: { temperature: 100 }, durationSec: 4 },
        { action: "Heat to 600 K.", expect: "Particles dart, wall hits get loud.", paramSet: { temperature: 600 }, durationSec: 4 },
        { action: "Push to 1200 K.", expect: "Bright high-pressure plasma-like gas.", paramSet: { temperature: 1200 }, durationSec: 4 },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Slow cycle.", expect: "Indicator traces a closed loop.", paramSet: { cycleSpeed: 0.2 }, durationSec: 6 },
        { action: "Standard cycle speed.", expect: "Plates glow alternately at hot/cold legs.", paramSet: { cycleSpeed: 0.5 }, durationSec: 5 },
        { action: "Faster cycle.", expect: "Same loop, just faster traversal.", paramSet: { cycleSpeed: 1.2 }, durationSec: 4 },
      ],
  ...
  },
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Slow cycle, watch glows.", expect: "Hot plate glows during expansion; cold during compression.", paramSet: { cycleSpeed: 0.25 }, durationSec: 6 },
        { action: "Speed up.", expect: "Loop still closes; work area unchanged.", paramSet: { cycleSpeed: 1.2 }, durationSec: 5 },
      ],
