...
export const quantumConcepts: Concept[] = [
  {
    ...
    experiment: {
      ...
      steps: [
        { action: "Set orbital=0 (s).", expect: "Spherical fuzzy cloud around nucleus." },
        { action: "Set orbital=1 (p_z).", expect: "Two lobes along vertical axis." },
        { action: "Set orbital=2 (d_z²).", expect: "Lobes + ring (donut)." },
        { action: "Set orbital=3 (d_x²−y²).", expect: "Four-lobed clover in horizontal plane." },
      ],
